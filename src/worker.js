...
let password = 'winser';  // 主页密码,建议修改或添加 PASSWORD环境变量
let proxyIP = '210.61.97.241:81';  // proxyIP
let yourUUID = '5dc15e15-f285-4a9d-959b-0e4fbdd7b666'; // UUID,建议修改或添加环境便量
    ...
    readable.pipeTo(new WritableStream({
        async write(chunk) {
            ...
            const {
                ...
                version,
                isUDP
            } = parseVLsPacketHeader(chunk, yourUUID);
...
<body>
    <div class="login-container">
        ...
        <div class="footer">
            <p>Powered by x <a href="#" target="_blank" style="color: #007bff; text-decoration: none;"> html</a></p>
        </div>
    </div>
